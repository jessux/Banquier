...
export const MERCHANT_DICTIONARY: MerchantDictionaryEntry[] = [
  ...
  { match: 'PAUL', category: BOULANGERIE },
  { match: 'LES BLES DOR', category: BOULANGERIE },
  { match: 'BANETTE', category: BOULANGERIE },
  { match: 'SPAR', category: ALIMENTATION },
  { match: 'G20', category: ALIMENTATION },
  { match: 'LEADER PRICE', category: ALIMENTATION },
  { match: 'SIMPLY MARKET', category: ALIMENTATION },
  { match: 'CARREFOUR MARKET', category: ALIMENTATION },
  { match: 'CARREFOUR CITY', category: ALIMENTATION },
  { match: 'CARREFOUR EXPRESS', category: ALIMENTATION },
  { match: 'CARREFOUR CONTACT', category: ALIMENTATION },
  { match: 'MONOP', category: ALIMENTATION },
  { match: 'CASINO SHOP', category: ALIMENTATION },
  { match: 'PETIT CASINO', category: ALIMENTATION },
  { match: 'SHOPI', category: ALIMENTATION },
  { match: 'COCCINELLE', category: ALIMENTATION },
  { match: 'COCCIMARKET', category: ALIMENTATION },
  { match: 'ED', category: ALIMENTATION },
  { match: 'DIA', category: ALIMENTATION },
  { match: 'THIRIET', category: ALIMENTATION },
  { match: 'SO BIO', category: ALIMENTATION },
  { match: 'BIOMONDE', category: ALIMENTATION },
  { match: 'EPICERIE', category: ALIMENTATION },
  { match: 'CAVE A VIN', category: ALIMENTATION },
  { match: 'NICOLAS', category: ALIMENTATION },
  { match: 'CAVAVIN', category: ALIMENTATION },
  { match: 'CHARCUTERIE', category: ALIMENTATION },
  { match: 'CREMERIE', category: ALIMENTATION },
  { match: 'MARCHE', category: ALIMENTATION },
  { match: 'MAXICOFFEE', category: ALIMENTATION },
  ...
  { match: 'STUART', category: LIVRAISON },
  ...
  { match: 'QUICK', category: FASTFOOD },
  { match: 'O TACOS', category: FASTFOOD },
  { match: 'PIZZA HUT', category: FASTFOOD },
  { match: 'PIZZA SPRINT', category: FASTFOOD },
  { match: 'SPEED RABBIT', category: FASTFOOD },
  { match: 'LA BOITE A PIZZA', category: FASTFOOD },
  { match: 'EXKI', category: FASTFOOD },
  { match: 'BAGELSTEIN', category: FASTFOOD },
  { match: 'CHIPOTLE', category: FASTFOOD },
  { match: 'POKAWA', category: FASTFOOD },
  { match: 'BIG FERNAND', category: FASTFOOD },
  { match: 'PRET A MANGER', category: FASTFOOD },
  { match: 'STARBUCKS', category: CAFE },
  { match: 'COLUMBUS CAFE', category: CAFE },
  { match: 'BRASSERIE', category: CAFE },
  { match: 'COSTA COFFEE', category: CAFE },
  { match: 'COFFEE', category: CAFE },
  { match: 'PAUSE CAFE', category: CAFE },
  ...
  { match: 'BISTROT', category: RESTAURANT },
  { match: 'PIZZERIA', category: RESTAURANT },
  { match: 'CREPERIE', category: RESTAURANT },
  { match: 'KEBAB', category: RESTAURANT },
  { match: 'INDIA', category: RESTAURANT },
  { match: 'WOK', category: RESTAURANT },
  { match: 'THAI', category: RESTAURANT },
  { match: 'L ENTRECOTE', category: RESTAURANT },
  { match: 'CAMPANILE RESTAURANT', category: RESTAURANT },
  { match: 'LA TABLE', category: RESTAURANT },
  { match: 'AU BUREAU', category: RESTAURANT },
  { match: 'BOCA', category: RESTAURANT },
  ...
  { match: 'CITIZ', category: 'Transport' },
  { match: 'UBEEQO', category: 'Transport' },
  { match: 'GETAROUND', category: 'Transport' },
  { match: 'OUICAR', category: 'Transport' },
  { match: 'SIXT', category: 'Transport' },
  { match: 'HERTZ', category: 'Transport' },
  { match: 'AVIS LOCATION', category: 'Transport' },
  { match: 'EUROPCAR', category: 'Transport' },
  { match: 'MICHELIN', category: 'Transport' },
  { match: 'EUROMASTER', category: 'Transport' },
  { match: 'VULCO', category: 'Transport' },
  { match: 'ROADY', category: 'Transport' },
  { match: 'CITROEN', category: 'Transport' },
  { match: 'PEUGEOT', category: 'Transport' },
  { match: 'RENAULT', category: 'Transport' },
  { match: 'DACIA', category: 'Transport' },
  { match: 'TESLA', category: 'Transport' },
  { match: 'IZIVIA', category: 'Transport' },
  { match: 'FLIXTRAIN', category: TRANSPORTS },
  { match: 'TGV INOUI', category: TRANSPORTS },
  { match: 'INTERCITES', category: TRANSPORTS },
  { match: 'TCL', category: TRANSPORTS },
  ...
  { match: 'PLOMBIER', category: ENTRETIEN },
  { match: 'ELECTRICIEN', category: ENTRETIEN },
  { match: 'SERRURIER', category: ENTRETIEN },
  { match: 'CHAUFFAGISTE', category: ENTRETIEN },
  { match: 'ILEK', category: ENERGIE },
  { match: 'PLANETE OUI', category: ENERGIE },
  { match: 'WEKIWI', category: ENERGIE },
  { match: 'ALPIQ', category: ENERGIE },
  { match: 'LA POSTE MOBILE', category: TELECOM },
  { match: 'CORIOLIS', category: TELECOM },
  { match: 'YOUPRICE', category: TELECOM },
  { match: 'CDISCOUNT MOBILE', category: TELECOM },
  { match: 'SYMA MOBILE', category: TELECOM },
  { match: 'AUCHAN TELECOM', category: TELECOM },
  { match: 'LAFORET', category: LOYER },
  { match: 'GESTRIM', category: LOYER },
  { match: 'IMMO DE FRANCE', category: LOYER },
  ...
  { match: 'BUT', category: MAISON },
  { match: 'CAMIF', category: MAISON },
  { match: 'SAINT MACLOU', category: MAISON },
  { match: 'SCHMIDT', category: MAISON },
  { match: 'MONSIEUR MEUBLE', category: MAISON },
  { match: 'BABOU', category: MAISON },
  { match: 'NATURE ET DECOUVERTES', category: SHOPPING },
  { match: 'SHOWROOMPRIVE', category: SHOPPING },
  { match: 'VEEPEE', category: SHOPPING },
  { match: 'LA REDOUTE', category: SHOPPING },
  { match: 'SEPHORA', category: SHOPPING },
  { match: 'MARIONNAUD', category: SHOPPING },
  { match: 'NOCIBE', category: SHOPPING },
  { match: 'YVES ROCHER', category: SHOPPING },
  { match: 'WORTEN', category: ELECTRONIQUE },
  { match: 'SAMSUNG', category: ELECTRONIQUE },
  { match: 'OYSHO', category: VETEMENTS },
  { match: 'PULL AND BEAR', category: VETEMENTS },
  { match: 'MASSIMO DUTTI', category: VETEMENTS },
  { match: 'SANDRO', category: VETEMENTS },
  { match: 'MAJE', category: VETEMENTS },
  { match: 'THE KOOPLES', category: VETEMENTS },
  { match: 'CAMAIEU', category: VETEMENTS },
  { match: 'ETAM', category: VETEMENTS },
  { match: 'DAMART', category: VETEMENTS },
  ...
  { match: 'IMAGERIE MEDICALE', category: MEDECIN },
  { match: 'CENTRE MEDICAL', category: MEDECIN },
  { match: 'MAISON MEDICALE', category: MEDECIN },
  ...
  { match: 'GRAND OPTICAL', category: MEDECIN },
  { match: 'KRYS', category: MEDECIN },
  { match: 'ALAIN AFFLELOU', category: MEDECIN },
  { match: 'OPTICAL CENTER', category: MEDECIN },
  { match: 'ATOL', category: MEDECIN },
  { match: 'GENERALE OPTIQUE', category: MEDECIN },
  ...
  { match: 'CGR', category: CINEMA },
  { match: 'SEETICKETS', category: CINEMA },
  { match: 'WEEZEVENT', category: CINEMA },
  ...
  { match: 'CLIMB UP', category: SPORT },
  { match: 'GYMLIB', category: SPORT },
  { match: 'CLASSPASS', category: SPORT },
  ...
  { match: 'LEGO', category: JEUX },
  { match: 'ESCAPE GAME', category: JEUX },
  { match: 'LASER GAME', category: JEUX },
  { match: 'BOWLING', category: JEUX },
  ...
  { match: 'DAZN', category: STREAMING },
  { match: 'RMC SPORT', category: STREAMING },
  { match: 'BEIN SPORTS', category: STREAMING },
  { match: 'PARAMOUNT', category: STREAMING },
  { match: 'OCS', category: STREAMING },
  { match: 'QOBUZ', category: STREAMING },
  { match: 'TIDAL', category: STREAMING },
  { match: 'SOUNDCLOUD', category: STREAMING },
  ...
  { match: 'SLACK', category: LOGICIELS },
  { match: 'ZOOM', category: LOGICIELS },
  { match: 'ASANA', category: LOGICIELS },
  { match: 'TRELLO', category: LOGICIELS },
  { match: 'MAILCHIMP', category: LOGICIELS },
  { match: 'SQUARESPACE', category: LOGICIELS },
  { match: 'WORDPRESS', category: LOGICIELS },
  { match: 'HOSTINGER', category: LOGICIELS },
  { match: 'LASTPASS', category: LOGICIELS },
  { match: 'BITWARDEN', category: LOGICIELS },
  { match: 'PCLOUD', category: LOGICIELS },
  { match: 'PROTONMAIL', category: LOGICIELS },
  { match: 'PROTONVPN', category: LOGICIELS },
  { match: 'MIDJOURNEY', category: LOGICIELS },
  { match: 'PERPLEXITY', category: LOGICIELS },
  { match: 'PATREON', category: 'Abonnements' },
  { match: 'SUBSTACK', category: 'Abonnements' },
  ...
  { match: 'ACCORHOTELS', category: HEBERGEMENT },
  { match: 'B B HOTELS', category: HEBERGEMENT },
  { match: 'KYRIAD', category: HEBERGEMENT },
  { match: 'BEST WESTERN', category: HEBERGEMENT },
  { match: 'BALLADINS', category: HEBERGEMENT },
  { match: 'ADAGIO', category: HEBERGEMENT },
  { match: 'HOTELS COM', category: HEBERGEMENT },
  ...
  { match: 'CORSAIR', category: VOYAGE_TRANSPORT },
  { match: 'AIR CARAIBES', category: VOYAGE_TRANSPORT },
  { match: 'WIZZAIR', category: VOYAGE_TRANSPORT },
  { match: 'NORWEGIAN', category: VOYAGE_TRANSPORT },
  { match: 'KLM', category: VOYAGE_TRANSPORT },
  { match: 'IBERIA', category: VOYAGE_TRANSPORT },
  { match: 'TAP PORTUGAL', category: VOYAGE_TRANSPORT },
  { match: 'OPODO', category: VOYAGE_TRANSPORT },
  { match: 'LASTMINUTE', category: VOYAGE_TRANSPORT },
  { match: 'GO VOYAGES', category: VOYAGE_TRANSPORT },
  ...
  { match: 'FUTUROSCOPE', category: TOURISME },
  { match: 'VULCANIA', category: TOURISME },
  { match: 'WALIBI', category: TOURISME },
  { match: 'NIGLOLAND', category: TOURISME },
  { match: 'AQUARIUM', category: TOURISME },
  { match: 'ZOO DE', category: TOURISME },
  ...
  { match: 'URSSAF', category: AIDES, direction: 'credit' },
  { match: 'MSA', category: AIDES, direction: 'credit' },
  { match: 'PRIME ACTIVITE', category: AIDES, direction: 'credit' },
  { match: 'APL', category: AIDES, direction: 'credit' },
  ...
  { match: 'INDEMNITES JOURNALIERES', category: REMBOURSEMENTS, direction: 'credit' },
  ...
  { match: 'DECOUVERT', category: FRAIS_BANCAIRES, direction: 'debit' }
]
