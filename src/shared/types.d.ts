...
export type AssetType = 'immobilier' | 'actions' | 'etf' | 'crypto' | 'liquidites' | 'assurance_vie' | 'autre';
...
export type RecurringFrequency = 'hebdomadaire' | 'mensuel' | 'bimestriel' | 'trimestriel' | 'semestriel' | 'annuel';
