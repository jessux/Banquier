...
Un relevé dont la mise en page ne comporte ni en-tête Débit/Crédit ni Montant renvoie simplement une liste vide (`errors: 1` côté UI) plutôt qu'un résultat inventé — testé et calé sur un relevé BNP Paribas réel ; la mise en page Date/Libellé/Valeur/Débit/Crédit est partagée par la plupart des banques françaises, mais n'a pas été vérifiée au-delà de cet échantillon.
